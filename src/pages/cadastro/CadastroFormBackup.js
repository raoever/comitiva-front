		...
		<>
			<Container maxWidth="md">
				<form onSubmit={handleSubmit(onSubmit)}>
					...
					<br/>
					<Accordion expanded={expanded} style={{display: editando && eDependente ? "none" : null}}>
						<AccordionSummary
					...
					<Accordion expanded={expanded} style={{display: editando && eDependente ? "none" : "block"}}>
						<AccordionSummary
							expandIcon={<ExpandMoreIcon/>}
					...
					<Accordion expanded={expanded} onClick={() => handleChange()}
							   style={{display: editando && !eDependente ? "none" : "block"}}>
						<AccordionSummary
							expandIcon={<ExpandMoreIcon/>}
											...
											render={({ field }) => (
												...
												>
													...
													>
														...
														<MenuItem value="Ensino Médio Técnico">Ensino Médio Técnico</MenuItem>
														<MenuItem value="EJA">EJA</MenuItem>
														<MenuItem value="Ensino Superior">Ensino Superior</MenuItem>
													</Select>
													<FormHelperText>
														Educação Infantil: duração de 4 anos, com alunos de 0 a 3 anos;<br/>
														Pré-escola: duração de 3 anos, com alunos de 4 a 6 anos;<br/>
														Ensino Fundamental: duração de 9 anos, com alunos de 6 a 14 anos;<br/>
														Ensino Médio: duração de 3 anos, com alunos de 15 a 17 anos;<br/>
														Ensino Médio Técnico: duração é variável, podendo ser de 1 a 3 anos.<br/>
